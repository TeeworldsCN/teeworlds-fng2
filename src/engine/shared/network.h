...
typedef int (*NETFUNC_DELCLIENT)(int ClientID, const char* pReason, void *pUser, bool ForceDisconnect);
...
public:
	...
	//
	int Drop(int ClientID, const char *pReason, bool ForceDisconnect = true);
